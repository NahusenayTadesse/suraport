...
<div class="relative">
    ...
    <div class="h-[45vh] bg-white dark:bg-black">

        <img src="https://images.unsplash.com/photo-1548991430-a8af941a8d69?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDZ8fEV0aGlvcGlhbiUyMGFydHxlbnwwfDB8MHx8fDA%3D" 
        
        alt="Sura Painting" 

        class="absolute left-1/2 transform -translate-x-1/2 w-[95%] h-[85vh]"
        >
    </div>
